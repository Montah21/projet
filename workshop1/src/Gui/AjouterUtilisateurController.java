...
public class AjouterUtilisateurController implements Initializable {
   ...
   UtilisateurService us = new UtilisateurService();
    ...
    void sign_up(ActionEvent event) {
         ...
         if (cinFiled.getText().isEmpty()|| nomField.getText().isEmpty()||prenomField.getText().isEmpty()|| passField.getText().isEmpty()||roleField.getText().isEmpty()||telField.getText().isEmpty()){
