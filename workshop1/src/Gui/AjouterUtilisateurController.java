...
public class AjouterUtilisateurController implements Initializable {
   ...
   UtilisateurService us = new UtilisateurService();
    ...
    void sign_up(ActionEvent event) {
         ...
         if (cinFiled.getText().length() > 8|| nomField.getText().isEmpty()||prenomField.getText().isEmpty()|| passField.getText().isEmpty()||roleField.getText().isEmpty()||telField.getText().length() > 10){
